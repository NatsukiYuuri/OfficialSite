class ScreenShot {
    ...
    private currentTab: "self"|"present" = "self";

    private readonly VIEW_NUM = 10;
    private readonly SELF_SS_MAX = 3;
    private readonly PRESENT_SS_MAX = 0;
    ...
    private UpdateTab() {
        // 選択中のタブ
        const selfTab = document.querySelector("#screen-shot-tab-self") as HTMLElement;
        const presentTab = document.querySelector("#screen-shot-tab-present") as HTMLElement;
        ...
        // 現在ある要素の削除
        const target = document.querySelector("#screen-shot-picture-list") as HTMLElement;
        if (target) {
